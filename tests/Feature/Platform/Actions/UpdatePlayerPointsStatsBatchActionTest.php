...
class UpdatePlayerPointsStatsBatchActionTest extends TestCase
{
    ...
    public function testItProcessesMultipleUsersInBatch(): void
    {
        ...
        $achievement1 = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievement2 = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 20]);
        ...
        $achievement3 = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 15]);
        ...
        $achievement4 = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 5]);
        $achievement5 = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 25]);
