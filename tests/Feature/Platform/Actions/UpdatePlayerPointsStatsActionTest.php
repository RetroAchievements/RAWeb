...
class UpdatePlayerPointsStatsActionTest extends TestCase
{
    ...
    public function testItDoesntAddStatsForUntrackedUsers(): void
    {
        ...
        $achievement = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 100]);
    ...
    public function testItCreatesStatsCorrectly(): void
    {
        ...
        $achievementOne = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievementTwo = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievementThree = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievementFour = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievementFive = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]); // deliberate no unlock
    ...
    public function testItUpdatesStatsCorrectly(): void
    {
        ...
        $achievementThree = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievementFour = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
        $achievementFive = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
    ...
    public function testItSkipsUpdateWhenValueIsUnchanged(): void
    {
        ...
        $system = System::factory()->create();
        $game = Game::factory()->create(['ConsoleID' => $system->id]);
        $achievement = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 10]);
    ...
    public function testItDeletesStatsWhenPointsReachZero(): void
    {
        ...
        $system = System::factory()->create();
        $game = Game::factory()->create(['ConsoleID' => $system->id]);
        $achievement = Achievement::factory()->published()->create(['game_id' => $game->id, 'points' => 50]);
