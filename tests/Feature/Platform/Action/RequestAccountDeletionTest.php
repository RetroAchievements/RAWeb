...
class RequestAccountDeletionTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testDeleteUnregistered(): void
    {
        ...
        $this->assertTrue((new RequestAccountDeletion())->execute($user));
        $user->refresh();
        ...
        $this->captureEmails();
        $this->assertFalse((new RequestAccountDeletion())->execute($user));
