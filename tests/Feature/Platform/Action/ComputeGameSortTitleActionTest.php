...
class ComputeGameSortTitleActionTest extends TestCase
{
    ...
    public static function titleProvider(): array
    {
        return [
            ...
            '007: Agent Under Fire' => ['007: Agent Under Fire', '0000007 agent under fire'],
            '101 Dalmatians' => ['101 Dalmatians', '00101 dalmatians'],
            '1nvader' => ['1nvader', '00001nvader'],
            '2048' => ['2048', '02048'],
            '20Q' => ['20Q', '00020q'],
            '2nd Space' => ['2nd Space', '00002nd space'],
            '3D Grand Prix' => ['3D Grand Prix', '00003d grand prix'],
            '50 Cent: Blood on the Sand' => ['50 Cent: Blood on the Sand', '00050 cent blood on the sand'],
            '64th. Street' => ['64th. Street', '00064th street'],
            ...
            'Mega Man X4' => ['Mega Man X4', 'mega man x00004'],
            ...
            'Super Mario 3D Land' => ['Super Mario 3D Land', 'super mario 00003d land'],
