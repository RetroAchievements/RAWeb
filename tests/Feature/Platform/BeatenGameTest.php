...
class BeatenGameTest extends TestCase
{
    ...
    public function testNoProgressionAchievementsAvailable(): void
    {
        ...
        $publishedAchievements = Achievement::factory()->promoted()->count(6)->create(['game_id' => $game->id]);
    ...
    public function testNoProgressionAchievementsUnlocked(): void
    {
        ...
        Achievement::factory()->promoted()->progression()->count(6)->create(['game_id' => $game->id]);
    ...
    public function testSomeProgressionAchievementsUnlocked(): void
    {
        ...
        Achievement::factory()->promoted()->winCondition()->create(['game_id' => $game->id]);
    ...
    public function testNoProgressionAndOneWinConditionAchievementUnlocked(): void
    {
        ...
        Achievement::factory()->promoted()->progression()->count(5)->create(['game_id' => $game->id]);
        $winConditionAchievement = Achievement::factory()->promoted()->winCondition()->create(['game_id' => $game->id]);
    ...
    public function testSomeHardcoreAndSomeSoftcoreUnlocks2(): void
    {
        ...
        $progressionAchievements = Achievement::factory()->promoted()->progression()->count(5)->create(['game_id' => $game->id]);
        $winConditionAchievements = Achievement::factory()->promoted()->winCondition()->count(2)->create(['game_id' => $game->id]);
    ...
    public function testBeatenAwardRevocation1(): void
    {
        ...
        Achievement::factory()->promoted()->progression()->create(['game_id' => $game->id]);
    ...
    public function testBeatenAwardRevocation2(): void
    {
        ...
        $newAchievement = Achievement::factory()->promoted()->progression()->create(['game_id' => $game->id]);
    ...
    public function testBeatenAwardRevocation3(): void
    {
        ...
        $progressionAchievement = Achievement::factory()->promoted()->progression()->create(['game_id' => $game->id]);
    ...
    public function testRetroactiveAward1(): void
    {
        ...
        $gameAchievements = Achievement::factory()->promoted()->count(6)->create(['game_id' => $game->id]);
    ...
    public function testRetroactiveAward3(): void
    {
        ...
        $gameAchievements = Achievement::factory()->promoted()->count(7)->create(['game_id' => $game->id]);
