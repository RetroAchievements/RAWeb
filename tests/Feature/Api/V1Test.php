...
class V1Test extends TestCase
{
    ...
    public function testGetAchievementDistribution(): void
    {
        ...
        $this->get($this->apiUrl('GetAchievementDistribution', ['i' => $game->ID, 'h' => UnlockMode::Hardcore, 'f' => AchievementFlags::Unofficial]))
            ->assertSuccessful()
            ->assertExactJson([
                '1' => 1,
                '2' => 0,
        ...
        $this->get($this->apiUrl('GetAchievementDistribution', ['i' => $game->ID, 'h' => UnlockMode::Softcore, 'f' => AchievementFlags::Unofficial]))
            ->assertSuccessful()
            ->assertExactJson([
                '1' => 0,
                '2' => 0,
