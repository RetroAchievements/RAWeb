...
class UserWantToPlayListTest extends TestCase
{
    ...
    public function testGetUserWantToPlayListOffset(): void
    {
        Carbon::setTestNow(Carbon::now());
    ...
    public function testGetUserWantToPlayListCount(): void
    {
        Carbon::setTestNow(Carbon::now());
    ...
    public function testGetUserWantToPlayListOffsetAndCount(): void
    {
        Carbon::setTestNow(Carbon::now());
