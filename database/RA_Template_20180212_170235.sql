...
CREATE TABLE IF NOT EXISTS `Activity` (
  ...
  `lastupdate` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'used to test for recent behaviour duplicates',
...
CREATE TABLE IF NOT EXISTS `StaticData` (
  ...
  `LastRegisteredUserAt` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `Ticket` (
  ...
  `ReportedAt` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
