...
function getOwnAchievementsObtained(string $user): bool|array|null
{
    ...
    $query = "SELECT 
              SUM(CASE WHEN aw.HardcoreMode = " . AchievementAwardType::Softcore . " THEN 1 ELSE 0 END) AS SoftcoreCount,
              SUM(CASE WHEN aw.HardcoreMode = " . AchievementAwardType::Hardcore . " THEN 1 ELSE 0 END) AS HardcoreCount
              FROM Achievements AS a
