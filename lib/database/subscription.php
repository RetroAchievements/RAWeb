 ...
 * @param styring $subjectType subject type
 ...
 * @return whether the user is subscribed to the subject
 */
 ...
 * @param string  $subjectType            subject type
 * @param integer $subjectID              subject id
 * @param integer $reqWebsitePref         optional required website preferences for a user to be considered a
 *                                        subscriber
 * @param string  $implicitSubscritionQry sql query that returns the set of users that are implicitly subscribed to
