    ...
    if ($consoleId === 21) {
        echo <<<HTML
            <div style="margin-bottom: 10px">
                <a href="/viewtopic.php?t=11108" class="info-button">⚠️️ Achievement developers are currently involved in a PlayStation 2 rollout. The planned launch date is October 1st, 2022 at 00:00 GMT! Click for more details. ⚠️</a>
            </div>
        HTML;
    }
}
