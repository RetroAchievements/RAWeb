  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div className="relative">
        ...
        {!props.multiple && (
          <span className="text-muted-foreground/80 pointer-events-none absolute inset-y-0 inset-e-0 flex h-full w-9 items-center justify-center peer-disabled:opacity-50">
            <LuChevronDown
