    ...
    return (
      <input
        ...
        className={cn(
          ...
          'file:my-1 file:mr-3 file:rounded-xs file:border-0 file:bg-embed file:p-2 file:text-sm file:font-medium file:text-link file:outline file:outline-1 file:outline-neutral-700',
          ...
          'focus-visible:outline-hidden focus-visible:ring-1 light:ring-offset-white light:placeholder:text-neutral-500 light:focus-visible:ring-neutral-950',
