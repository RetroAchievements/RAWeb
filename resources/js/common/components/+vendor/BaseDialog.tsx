...
const BaseDialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { shouldBlurBackdrop?: boolean }
>(({ className, children, shouldBlurBackdrop = false, ...props }, ref) => {
  ...
  return (
    <BaseDialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg bg-embed',
