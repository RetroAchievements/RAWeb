...
const baseTabsTriggerVariants = cva([], {
  variants: {
    variant: {
      ...
      underlined: cn(
        'text-center h-full px-3 font-medium text-xs text-neutral-500 light:text-neutral-700 border-b-2 light:border-b-4 border-transparent flex-1 whitespace-nowrap',
