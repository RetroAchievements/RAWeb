  ...
  variants: {
    variant: {
      default: cn(
        ...
        'inline-flex items-center justify-center whitespace-nowrap rounded-xs px-3 py-1.5',
        'text-sm font-medium transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2',
        'disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-neutral-950 data-[state=active]:shadow-xs',
      ),
      underlined: cn(
