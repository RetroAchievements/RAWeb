...
type SystemChipProps = App.Platform.Data.System & { children?: ReactNode; className?: string };

export const SystemChip: FC<SystemChipProps> = ({ iconUrl, nameShort, children, className }) => {
