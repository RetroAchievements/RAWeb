  ...
  return (
    <div
      ...
      className={cn(
        ...
        hasCustomBanner ? 'lg:h-86' : 'lg:h-53',
        hasCustomBanner && bannerPreference === 'compact' ? 'lg:h-53!' : null,
        hasCustomBanner && bannerPreference === 'expanded' ? 'lg:h-118.5!' : null,
    ...
    >
      ...
      {banner?.desktopMdWebp ? (
        <div className="absolute inset-0 overflow-hidden">
          <div className="relative mx-auto h-full max-w-480">
            <img
      ...
      {banner?.desktopMdWebp ? (
        <div
          className="relative mx-auto h-full max-w-480 overflow-hidden"
          style={{
      ...
      <div
        className={cn(
          ...
          'bg-linear-to-b from-black/40 from-0% via-black/50 via-60% to-black',
