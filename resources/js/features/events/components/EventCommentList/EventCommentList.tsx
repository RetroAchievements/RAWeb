...
export const EventCommentList: FC = () => {
  const { can, event, isSubscribedToComments, numComments, recentVisibleComments } =
  ...
  return (
    <div id="comments" className="flex flex-col gap-2">
            ...
            {numComments > 20 ? (
              <Trans
                ...
                components={{
                  1: (
                    <InertiaLink
                      href={route('event.comment.index', { event: event.id })}
      ...
      <CommentList
        ...
        canComment={!!can.createEventComments}
