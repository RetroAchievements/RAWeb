...
describe('Component: EventAchievementSetContainer', () => {
  it('renders without crashing', () => {
    // ARRANGE
    const event = createRaEvent();
    const { container } = render(<EventAchievementSetContainer event={event} />);
  ...
  it('given the event has no achievements, renders an empty state', () => {
    ...
    render(<EventAchievementSetContainer event={event} />);
