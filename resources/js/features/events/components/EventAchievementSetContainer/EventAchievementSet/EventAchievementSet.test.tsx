...
describe('Component: EventAchievementSet', () => {
  it('renders without crashing', () => {
    // ARRANGE
    const { container } = render(
      <EventAchievementSet achievements={[]} currentSort="active" playersTotal={0} />,
    );
  ...
  it('given an empty achievements array, renders an empty list', () => {
    // ARRANGE
    render(<EventAchievementSet achievements={[]} currentSort="active" playersTotal={0} />);
