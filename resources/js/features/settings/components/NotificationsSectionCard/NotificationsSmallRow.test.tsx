...
describe('Component: NotificationsSmallRow', () => {
  it('renders without crashing', () => {
    ...
    const { container } = render(
      <Wrapper>
        <NotificationsSmallRow t_label="t_label" emailFieldName="0" siteFieldName="1" />
      </Wrapper>,
    );
  ...
  it('given there is no email field name, does not render an email me checkbox', () => {
    ...
    render(
      <Wrapper>
        <NotificationsSmallRow t_label="t_label" siteFieldName="1" />
      </Wrapper>,
    );
  ...
  it('given there is no site field name, does not render a notify me on the site checkbox', () => {
    ...
    render(
      <Wrapper>
        <NotificationsSmallRow t_label="t_label" emailFieldName="1" />
      </Wrapper>,
    );
