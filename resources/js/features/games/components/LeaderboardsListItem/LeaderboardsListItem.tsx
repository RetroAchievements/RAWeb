    ...
    >
      <div className="flex flex-col gap-y-1 md:mt-1">
        ...
        <a
          ...
          className="group flex size-16 flex-col items-center justify-center gap-0.5 rounded-xs bg-embed light:border light:border-neutral-300 light:bg-white"
        >
          {leaderboard.state === 'active' || leaderboard.state === 'unpromoted' ? (
            ...
            <BaseTooltip>
              <BaseTooltipTrigger asChild data-testid="disabled-tooltip-trigger">
                <span className="flex size-16 cursor-pointer flex-col items-center justify-center gap-0.5 rounded-xs">
