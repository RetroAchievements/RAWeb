...
describe('Component: SidebarClaimButtons', () => {
  ...
  it('given the policy denies creation, hides the collaboration claim button', () => {
    ...
    // ASSERT
    expect(
      screen.queryByRole('button', { name: /create new collaboration claim/i }),
    ).not.toBeInTheDocument();
  });
  ...
  it('given the user has unresolved tickets, still shows create claim button', () => {
    // ARRANGE
    render(<SidebarClaimButtons />, {
      pageProps: {
        can: { createAchievementSetClaims: true },
  ...
  it('given the user has one unresolved ticket, shows create claim button', () => {
    // ARRANGE
    render(<SidebarClaimButtons />, {
      pageProps: {
        can: { createAchievementSetClaims: true },
