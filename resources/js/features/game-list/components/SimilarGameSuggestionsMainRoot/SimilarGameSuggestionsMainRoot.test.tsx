...
import { SimilarGameSuggestionsMainRoot } from './SimilarGameSuggestionsMainRoot';

// Suppress AggregateError invocations from unmocked fetch calls to the back-end.
console.error = vi.fn();

describe('Component: SimilarGameSuggestionsMainRoot', () => {
  ...
  it('displays default columns', async () => {
    // ARRANGE
    render<App.Platform.Data.GameSuggestPageProps>(<SimilarGameSuggestionsMainRoot />, {
      pageProps: {
        sourceGame: createGame(),
        paginatedGameListEntries: createPaginatedData([
          createGameSuggestionEntry(),
  ...
  it('displays an accessible link to personalized suggestions', () => {
    // ARRANGE
    render<App.Platform.Data.GameSuggestPageProps>(<SimilarGameSuggestionsMainRoot />, {
      pageProps: {
        auth: { user: createAuthenticatedUser() },
