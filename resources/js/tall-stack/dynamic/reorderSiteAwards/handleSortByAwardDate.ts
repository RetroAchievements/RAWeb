export function handleSortByAwardDate(direction: 'asc' | 'desc', awardKind: string): void {
  ...
  const rows = Array.from(tbody.querySelectorAll<HTMLTableRowElement>('.award-table-row')).filter(
