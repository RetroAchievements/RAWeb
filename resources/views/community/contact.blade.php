    ...
    <div class="lg:grid grid-cols-2 gap-5">
        <div>
            <x-section>
                ...
                <p class="mb-0">
                    <a href='{{ route("message.new") }}?to=RAdmin'>Send a message to RAdmin</a> for:
                </p>
            ...
            <x-section>
                ...
                <p class="mb-0">
                    <a href='{{ route("message.new") }}?to=DevCompliance'>Send a message to DevCompliance</a> for:
                </p>
            ...
            <x-section>
                ...
                <p class="mb-0">
                    <a href='{{ route("message.new") }}?to=QATeam'>Send a message to QATeam</a> for:
                </p>
            ...
            <x-section>
                ...
                <p class="mb-3">
                    <a href='{{ route("message.new") }}?to=DevQuest'>Send a message to DevQuest</a> for
        ...
        <div>
            <x-section>
                ...
                <p class="mb-3">
                    <a href="{{ route("message.new") }}?to=RACheats">Send a message to RACheats</a>
            ...
            <x-section>
                ...
                <p class="mb-0">
                    <a href='{{ route("message.new") }}?to=RANews'>Send a message to RANews</a> for:
                </p>
            ...
            <x-section>
                ...
                <p class="mb-3">
                    <a href='{{ route("message.new") }}?to=RAEvents'>Send a message to RAEvents</a> for
                    submissions, questions, ideas, or reporting issues related to
                    <a href='/game/3105'>community events</a>.
                </p>

                <p class="mb-3">
                    <a href='{{ route("message.new") }}?to=TheUnwanted'>Send a message to TheUnwanted</a> for
