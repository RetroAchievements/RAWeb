...
$lbData = GetLeaderboardData($lbID, $user?->username, $count, $offset);
        ...
        if (isset($user) && $permissions >= Permissions::JuniorDeveloper) {
            ...
            if (!empty($lbData['Entries'])) {
                ...
                foreach ($lbData['Entries'] as $nextLBEntry) {
                    ...
                    // TODO use a policy
                    if (($user->username == $nextLBEntry['User'] && $permissions == Permissions::JuniorDeveloper) || $permissions >= Permissions::Developer) {
