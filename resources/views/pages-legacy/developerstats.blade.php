...
<x-app-layout pageTitle="Developer Stats">
    ...
    foreach ($devStatsList as $devStats) {
        ...
        echo "<td class='text-right'><a href='" . route('developer.tickets.resolved', ['user' => $devStats['Author'], 'filter[publishedStatus]' => 'published', 'filter[developer]' => 'others', 'filter[reporter]' => 'others']) ."'>" . localized_number($devStats['TicketsResolvedForOthers']) . "</a></td>";
        echo "<td class='text-right'>" . localized_number($devStats['yield_unlocks']) . "</td>";
        echo "<td class='text-right'>" . localized_number($devStats['yield_points']) . "</td>";
