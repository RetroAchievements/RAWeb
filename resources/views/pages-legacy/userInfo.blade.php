...
$userClaimData = null;
if ($userPageModel->achievementSetClaims()->activeOrInReview()->exists()) {
...
>
    ...
    if ($canShowProgressionStatusComponent) {
        ...
        echo "<div class='mt-1 mb-8 bg-embed p-5 rounded-sm sm:p-2.5 md:p-5 lg:p-3 xl:p-5'>";
        ?>
    ...
    <x-slot name="sidebar">
        ...
        @if ($user !== null && $user === $userPageModel['username'])
