...
<div
    role="alert"
    class="flex gap-x-4 w-full rounded-sm border-2 p-4 {{ $variant === 'destructive' ? 'border-red-500 text-red-400 bg-red-950 light:bg-red-100' : 'border-embed-highlight bg-embed' }}"
>
