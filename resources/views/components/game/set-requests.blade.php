...
function getSetRequestInformation(user, gameID) {
    $.post('/request/user-game-list/set-requests.php', {
        ...
        .done(function (results) {
            ...
            $('.gameRequestsLabel').html('Set Requests: <a href="{{ route("game.requests.index", ["game" => $gameId]) }}">' + gameTotal + '</a>');
...
<div>
    ...
    <div class='gameRequestsLabel'>Set Requests: <a href='{{ route("game.requests.index", ["game" => $gameId]) }}'>{{ $gameRequests }}</a></div>
