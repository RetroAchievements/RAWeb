...
{
    //$resp = recaptcha_check_answer( "6Lc7pu4SAAAAAJVYtsAQfIsr-onnzssNwtx1uQTS",
    //								$_SERVER["REMOTE_ADDR"],
    ...
    $data = array( 'secret' => '6Lc7pu4SAAAAAJVYtsAQfIsr-onnzssNwtx1uQTS', 'response' => $_POST[ 'g-recaptcha-response' ] );
...
$query = "INSERT INTO UserAccounts VALUES ( NULL, \"$user\", \"$saltedPass\", \"$email\", 0, 0, 0, 0, '', '', NULL, 63, 0, 0, \"\", 0, 0, \"\", 0, 0, \"Unknown\", NULL, 0, 0, 0, 1, NULL, false )";
log_sql( $query );
$dbResult = s_mysql_query( $query );
...
if( $dbResult !== FALSE )
{
    ...
    if( copy( "/var/www/html/UserPic/_User.png", "/var/www/html/UserPic/$user.png" ) == FALSE )
    {
