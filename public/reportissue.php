...
<body>
    ...
    <div id="mainpage">
        <div id='leftcontainer'>
            ...
            echo "<td>Emulator:</td>";
            echo "<td>";
            echo "<select name='note[emulator]' id='emulator' onclick='diplayCore()'>";
            ...
            echo "<td>";
            echo "<input type='text' name='note[checksum]' id='checksum'>";
            echo "</td>";
            ...
            echo "style='height:160px' rows='5' cols='61' name='note[description]' id='description' placeholder='Describe your issue here...'></textarea>";
            echo "</td>";
            echo "</tr>";
