    ...
    <?php
        function generateMetaDescription(
            ...
            if ($isEventGame) {
                ...
                return "No achievements have been created yet for $gameTitle. Join RetroAchievements for updates on $gameTitle for $consoleName and many other classic games.";
            }
