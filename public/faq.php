...
<div id="mainpage">
	...
	<div id="rsslist" class="both">
		...
		echo "<p>Enjoy! Do whatever you like; here's a <a href='http://i.retroachievements.org/Images/RA_LogoLarge.png'>link to a high-resolution logo</a>. Please enjoy responsibly and spread the word about RA as you wish ;)</br></br>";
		
		echo "<h4 class='longheader' id='faq11'>How can I assign a controller button to view the achievement overlay?</h4>";
		echo "<p>Some of the emulators should already be setup for this. Generally ESC on the keyboard should activate it, but if you want to assign it to a controller, see <a href='http://retroachievements.org/viewtopic.php?t=2323&c=12084'>this link</a>.</br></br>";
