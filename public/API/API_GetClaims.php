 ...
 *    int        Status             claim status: 0 - active, 1 - complete, 2 - dropped, 3 - in review
...
$claimsResults = getFilteredClaims(claimFilter: $claimFilter, limit: 1000, useLegacyIntegers: true);
