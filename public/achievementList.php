...
<div id='mainpage'>
    <div id='fullcontainer'>
        ...
        if ($offset > 0) {
            ...
            echo "<a href='/achievementList.php?s=$sortBy&o=$prevOffset&p=$params$dev_param' class='previousbutton'><img id='loadingicon' src='http://localhost:80/Images/backwardarrow.png' alt='loading icon' width='46' height='26'></a>";
        }
        if ($achCount == $maxCount) {
            // Max number fetched, i.e. there are more. Can goto next 25.
            $nextOffset = $offset + $maxCount;
            echo "<a href='/achievementList.php?s=$sortBy&o=$nextOffset&p=$params$dev_param' class='nextbutton'><img id='loadingicon' src='http://localhost:80/Images/forwardarrow.png' alt='loading icon' width='46' height='26'></a>";
        }
        echo "</div>";
        ?>
        <br>
