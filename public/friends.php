    ...
    <div id="fullcontainer">
        ...
        if (!isset($friendsList)) {
            ...
            foreach ($friendsList as $friendEntry) {
                ...
                echo "<span style='display:block;'><a href='/request/requestchangefriend.php?u=$user&amp;c=$cookie&amp;f=$nextFriendName&amp;a=0'>Remove&nbsp;Friend</a></span>";
                echo "<span style='display:block;'><a href='/request/requestchangefriend.php?u=$user&amp;c=$cookie&amp;f=$nextFriendName&amp;a=-1'>Block&nbsp;User</a></span>";
                echo "</div>";
                echo "</td>";
