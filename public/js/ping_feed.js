...
function refreshFeed( friendsOnly )
{
	...
	$("#feed tbody").empty();
	$("#feed tbody").html( "<tr id='feedloadingfirstrow'><td class='chatcell'><img src='http://i.retroachievements.org/Images/loading.gif' width='16' height='16'/></td><td class='chatcell'></td><td class='chatcellmessage'>Loading feed...</td></tr>" );
...
function pushFeedItem( feedItemID, timestamp, acttype, user, userPoints, userMotto, data, data2, gameTitle, gameID, gameIcon, consoleName, achTitle, achDesc, achBadge, achPoints, lbTitle, lbDesc, lbFormat )
{
	...
	if( localUser !== null )
		...
		//insertRowHtml += "<td class='editbutton'><img src='http://i.retroachievements.org/Images/Edit.png' width='16' height='16' style='cursor: pointer;' onclick=\"insertEditForm( '" + rowID.toString() + "', '" + acttype.toString() + "' )\" /></td>";
		insertRowHtml += "<td class='editbutton'><img src='http://i.retroachievements.org/Images/Edit.png' width='16' height='16' style='cursor: pointer;' onclick=\"insertEditForm( '" + rowID.toString() + "', '5' )\" /></td>";
