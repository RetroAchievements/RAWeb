...
function refreshFeed(friendsOnly) {
  ...
  $feed.empty();
  $feed.html(
    '<tr id=\'feedloadingfirstrow\'><td class=\'chatcell\'><img src=\'https://s3-eu-west-1.amazonaws.com/i.retroachievements.org/Images/loading.gif\' width=\'16\' height=\'16\'/></td><td class=\'chatcell\'></td><td class=\'chatcellmessage\'>Loading feed...</td></tr>'
  );
...
function pushFeedItem(
  ...
  if (localUser !== null) {
    ...
    insertRowHtml += '<td class=\'editbutton\'><img src=\'https://s3-eu-west-1.amazonaws.com/i.retroachievements.org/Images/Edit.png\' width=\'16\' height=\'16\' style=\'cursor: pointer;\' onclick="insertEditForm( \''
      + rowID.toString() + '\', \'5\' )" /></td>';
  }
