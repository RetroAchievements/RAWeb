...
<article>
    ...
    echo "<br><div class='text-danger'><b>Warning:</b> PLEASE be careful with this tool. If in doubt, <a href='" . route('message.new') . "?to=RAdmin&subject=Attempt+to+Unlink+" . urlencode($gameTitle) ."&message=%5Bgame=$gameID%5D'>leave a message for admins</a> and they'll help sort it.</div>";
