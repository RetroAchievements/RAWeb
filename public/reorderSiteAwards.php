...
<div id="mainpage">
    <div id="<?= $hasSomeAwards ? 'leftcontainer' : 'fullcontainer' ?>">
        ...
        function RenderAwardOrderTable(
            ...
            ?array $userCompletedGamesList = null
        ): void {
            // "Game Awards" -> "game"
        ...
        if (!empty($gameAwards)) {
            RenderAwardOrderTable("Game Awards", $gameAwards, $awardCounter, $renderedSectionCount, $prefersSeeingSavedHiddenRows, $initialSectionOrders[0], $userCompletedGamesList);
        }
