                        ...
                        ->resources(function ($server) {
                            ...
                            $server->resource('users', UserController::class)
                                ...
                                ->relationships(function ($relationships) {
                                    ...
                                    $relationships->hasMany('followers')->readOnly()->middleware(RequireOAuthTokenWithScope::class . ':' . OAuthScope::FollowsRead->value);
                                    $relationships->hasMany('following')->readOnly()->middleware(RequireOAuthTokenWithScope::class . ':' . OAuthScope::FollowsRead->value);
                                    ...
                                    $relationships->hasMany('tickets')->readOnly();
                                    $relationships->hasMany('userGameListEntries')->readOnly()->middleware(RequireOAuthTokenWithScope::class . ':' . OAuthScope::GameListsRead->value);
