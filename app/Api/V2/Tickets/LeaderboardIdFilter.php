...
final class LeaderboardIdFilter implements Filter
{
    ...
    public function apply($query, $value)
    {
        ...
        // both predicates are needed to prevent achievement tickets with colliding ids from leaking
        return $query
            ...
            ->map(function (string $v) {
                if (!ctype_digit($v)) {
                    throw JsonApiException::error([
                        ...
                        'detail' => "Invalid leaderboard id [{$v}].",
                    ]);
                }
