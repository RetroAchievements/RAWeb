...
class DeveloperSetsService
{
    ...
    public function buildViewData(Request $request, User $user): array
    {
        ...
        $columns['achievements']['tooltip'] = "The number of achievements created by {$user->username} in the set";
        ...
        $columns['points']['tooltip'] = "The number of points associated to achievements created by {$user->username} in the set";
        ...
        $columns['leaderboards']['tooltip'] = "The number of leaderboards created by {$user->username} in the set";
        ...
        $columns['tickets']['tooltip'] = "The number of open tickets for achievements created by {$user->username} in the set";
