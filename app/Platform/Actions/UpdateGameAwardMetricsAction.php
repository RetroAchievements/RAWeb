...
use App\Platform\Events\GameAwardMetricsUpdated;
use Illuminate\Database\Eloquent\Builder;

class UpdateGameAwardMetricsAction
{
    public function execute(Game $game): void
    {
        // Get median time to beat for softcore.
        ...
        // Get median time to beat for hardcore.
        $query = PlayerGame::where('game_id', $game->id)
        ...
        GameAwardMetricsUpdated::dispatch($game);
    }
