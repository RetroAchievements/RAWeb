...
<div id='leftcontainer'>
	<?php
		...
		if( $mobileSetting == 1 )
		{
			echo "<iframe id='player' type='text/html' width='620' height='378' src='http://www.twitch.tv/retroachievementsorg/hls' frameborder='0'></iframe>";
		}
		...
		if( $permissions > 1 )
		{
			...
			echo "</br>";
			echo "<ul>";
			echo "<li><a href='http://www.twitch.tv/retroachievementsorg/dashboard'>Dashboard on Twitch.tv - select game on this page!</a></li>";
