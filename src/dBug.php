		...
		echo <<<SCRIPTS
			...
			<style type="text/css">
				table.dBug_array,table.dBug_object,table.dBug_resource,table.dBug_resourceC,table.dBug_xml {
					font-family:Verdana, Arial, Helvetica, sans-serif; color:#000000; font-size:12px; margin: 2px;
				}
				...
				.dBug_xmlHeader 
					{ font-weight:bold; color:#FFFFFF; cursor:pointer; padding:2px; }
